...
struct DaySummaryBuilderTests {
  ...
  let today = calendar.date(from: DateComponents(year: 2026, month: 7, day: 4, hour: 14))!
  let yesterday = calendar.date(from: DateComponents(year: 2026, month: 7, day: 3, hour: 10))!
